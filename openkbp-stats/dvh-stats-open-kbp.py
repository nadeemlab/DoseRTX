...
# planName = 'echoBeamMomLossPTVgEUD2'
# gt_dir = '/nadeem_lab/Gourav/rtdose-prediction/datasets/msk-echo-3d-dvh-beamlet-sparse-separate-ptv/test'
# gt_dir = '/nadeem_lab/Gourav/rtdose-prediction/datasets/msk-manual-3d-dvh-beamlet-dense-separate-ptv/test'
gt_dir = '/nadeem_lab/Gourav/datasets/boo/test'
pred_dir = './results/{}/test_latest/npz_images'.format(planName)
# out_dir = './echoBeamMomLossW0_1NewPTV'
...
with open(metrics_filename, append_write) as f:
    # Print headings
